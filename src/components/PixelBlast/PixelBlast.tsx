...
const createTouchTexture = () => {
  ...
  interface TrailPoint {
    x: number; y: number; age: number; force: number; vx: number; vy: number;
  }
  ...
  useEffect(() => {
    ...
    if (!threeRef.current) mustReinit = true;
      ...
      for (const k of needsReinitKeys)
        if ((prevConfigRef.current as Record<string, unknown>)[k] !== (cfg as Record<string, unknown>)[k]) {
          mustReinit = true;
          break;
        }
    }
