      ...
      <div className="max-w-[1100px] mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-10">
        ...
        <div className="flex flex-col items-center md:items-start gap-5">
          <div className="flex gap-6">
            <a href="https://www.instagram.com/team_axen/" target="_blank" rel="noopener noreferrer" className="text-[var(--text-faint)] hover:text-[var(--accent)] hover:-translate-y-1 transition-all">
            ...
            <a href="https://github.com/AdiTheCoder00" target="_blank" rel="noopener noreferrer" className="text-[var(--text-faint)] hover:text-[var(--accent)] hover:-translate-y-1 transition-all">
